...
#
# nano ~/Desktop/start_offset.desktop

# [Desktop Entry]
# Type=Application
# Name=start_offset
# Comment=Robot-Alignment: rebuild + launch offset stack
# Terminal=false
# Exec=terminator --fullscreen -x bash -lc "$HOME/Robot-Alignment/ShellScripts/start_offset.sh"
# Icon=utilities-terminal
# Categories=Development;
# StartupNotify=true
#
# chmod +x ~/Desktop/start_offset.desktop
...
#   USE_CAMERA=false USE_ROBOT=false ~/Robot-Alignment/ShellScripts/start_offset.sh
...
if command -v terminator >/dev/null 2>&1; then
  ...
  TERM_CMD=(gnome-terminal --title="RA: offset" -- bash -lc)
else
