...
#
# Launcher in ~/Robot-Alignment/ShellScripts
# nano ~/Robot-Alignment/ShellScripts/run_markerless_alignment.desktop
...
# Terminal=false
# Exec=terminator --fullscreen -x bash -lc "$HOME/Robot-Alignment/ShellScripts/run_markerless_alignment.sh"
# Icon=utilities-terminal
# Categories=Development;
# StartupNotify=true
#
# chmod +x ~/Robot-Alignment/ShellScripts/run_markerless_alignment.desktop
# gio set ~/Robot-Alignment/ShellScripts/run_markerless_alignment.desktop metadata::trusted true
#
