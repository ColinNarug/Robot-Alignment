...
#
# nano ~/Desktop/start_pbvs.desktop
#
# [Desktop Entry]
# Type=Application
# Name=start_pbvs
# Comment=Robot-Alignment: rebuild + launch pbvs stack
# Terminal=false
# Exec=terminator --fullscreen -x bash -lc "$HOME/Robot-Alignment/ShellScripts/start_pbvs.sh"
# Icon=utilities-terminal
# Categories=Development;
# StartupNotify=true
#
# chmod +x ~/Desktop/start_pbvs.desktop
...
SESSION="ra_pbvs"
LAUNCH_FILE="start_pbvs.launch.py"

# Toggle these when you're unplugged:
#   USE_CAMERA=false USE_ROBOT=false ~/Robot-Alignment/ShellScripts/start_pbvs.sh
...
if command -v terminator >/dev/null 2>&1; then
  ...
  TERM_CMD=(gnome-terminal --title="RA: pbvs" -- bash -lc)
else
