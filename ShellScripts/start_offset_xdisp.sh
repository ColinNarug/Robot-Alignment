...
#
# nano ~/Desktop/start_offset_xdisp.desktop
#
# [Desktop Entry]
# Type=Application
# Name=start_offset_xdisp
# Comment=Robot-Alignment: rebuild + launch offset_xdisp stack
# Terminal=false
# Exec=terminator --fullscreen -x bash -lc "$HOME/Robot-Alignment/ShellScripts/start_offset_xdisp.sh"
# Icon=utilities-terminal
# Categories=Development;
# StartupNotify=true
#
# chmod +x ~/Desktop/start_offset_xdisp.desktop
...
SESSION="ra_offset_xdisp"
LAUNCH_FILE="start_offset_xdisp.launch.py"

# Toggle these when you're unplugged:
#   USE_CAMERA=false USE_ROBOT=false ~/Robot-Alignment/ShellScripts/start_offset_xdisp.sh
...
if command -v terminator >/dev/null 2>&1; then
  ...
  TERM_CMD=(gnome-terminal --title="RA: offset_xdisp" -- bash -lc)
else
