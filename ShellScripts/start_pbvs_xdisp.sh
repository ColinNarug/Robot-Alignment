...
#
# nano ~/Desktop/start_pbvs_xdisp.desktop
#
# [Desktop Entry]
# Type=Application
# Name=start_pbvs_xdisp
# Comment=Robot-Alignment: rebuild + launch pbvs_xdisp stack
# Terminal=false
# Exec=terminator --fullscreen -x bash -lc "$HOME/Robot-Alignment/ShellScripts/start_pbvs_xdisp.sh"
# Icon=utilities-terminal
# Categories=Development;
# StartupNotify=true
#
# chmod +x ~/Desktop/start_pbvs_xdisp.desktop
...
SESSION="ra_pbvs_xdisp"
LAUNCH_FILE="start_pbvs_xdisp.launch.py"

# Toggle these when you're unplugged:
#   USE_CAMERA=false USE_ROBOT=false ~/Robot-Alignment/ShellScripts/start_pbvs_xdisp.sh
...
if command -v terminator >/dev/null 2>&1; then
  ...
  TERM_CMD=(gnome-terminal --title="RA: pbvs_xdisp" -- bash -lc)
else
